        ...
        <div>
          ...
          <h1 className="hero-headline" style={{ fontFamily:fSerif, fontSize:"clamp(40px,7vw,84px)", fontWeight:400, color:"#EEF2F7", margin:"0 0 20px", letterSpacing:"-0.035em", lineHeight:0.98, textAlign:"center" }}>
            {lang==="de" ? <>Von Angebot<br/>zu Zahlung.<br/><span style={{ color:"#17A99E", fontStyle:"italic" }}>Erledigt.</span></> :
             lang==="fr" ? <>De la proposition<br/>au paiement.<br/><span style={{ color:"#17A99E", fontStyle:"italic" }}>Gere.</span></> :
             ...
             lang==="hu" ? <>Az ajanlattol<br/>a kifizetesig.<br/><span style={{ color:"#17A99E", fontStyle:"italic" }}>Kesz.</span></> :
          ...
          <p className="hero-sub" style={{ fontFamily:fSans, fontSize:14, color:"rgba(238,242,247,0.55)", lineHeight:1.7, maxWidth:340, margin:"0 auto 28px", fontWeight:300, textAlign:"center", letterSpacing:"0.01em" }}>
            {lang==="de" ? "Angebote, Rechnungen, Zahlungen und EU-Compliance in einem ruhigen Workflow." :
             lang==="fr" ? "Propositions, factures, paiements et conformite UE dans un flux simple." :
          ...
          <div className="hero-constellation-mobile" style={{ margin:"0 auto 28px", position:"relative", width:"100%", maxWidth:300, height:170 }}>
            <svg style={{ width:"100%", height:"100%", overflow:"visible" }} viewBox="0 0 320 200">
              ...
              <text x="174" y="84" fontFamily="'DM Sans',sans-serif" fontSize="10" fill="rgba(238,242,247,0.45)" fontWeight="400">Viewed 7x</text>
          ...
          <div className="hero-btns" style={{ display:"flex", gap:10, justifyContent:"center", flexWrap:"wrap", marginBottom:20 }}>
            ...
            <button onClick={function(){ setPage("Generator"); }} style={{ background:"rgba(255,255,255,0.05)", color:"rgba(238,242,247,0.6)", border:"1px solid rgba(255,255,255,0.09)", padding:"14px 24px", borderRadius:9, cursor:"pointer", fontFamily:fSans, fontSize:15, whiteSpace:"nowrap" }}>
              {lang==="de" ? "Demo ansehen" : lang==="fr" ? "Voir la demo" : "View demo"}
            </button>
          </div>
      ...
      <div className="desktop-section" style={{ maxWidth:1060, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:60 }}>
          ...
          <h2 style={{ fontFamily:fSerif, fontSize:"clamp(26px,4vw,44px)", fontWeight:400, color:"#F0F4F8", margin:"0 0 12px", letterSpacing:"-0.025em", lineHeight:1.1, fontStyle:"italic" }}>
            {lang==="de" ? "Von der Idee zur Zahlung" : lang==="fr" ? "De l'idee au paiement" : lang==="es" ? "De la idea al cobro" : lang==="it" ? "Dall'idea al pagamento" : lang==="hu" ? "Az oetlettol a kifizetesig" : "From idea to payment"}
          </h2>
          <p className="d-section-sub" style={{ fontFamily:fSans, fontSize:14, color:"rgba(240,244,248,0.45)", fontWeight:300, maxWidth:400, margin:"0 auto" }}>
            {lang==="de" ? "Vier Schritte. Ein Tool. Kein Wechsel zwischen Apps." : lang==="fr" ? "Quatre etapes. Un outil." : lang==="es" ? "Cuatro pasos. Una herramienta." : lang==="it" ? "Quattro passi. Un solo strumento." : lang==="hu" ? "Negy lepes. Egy eszkoez." : "Four steps. One tool. No switching."}
          </p>
        </div>
...
export function FlowSection(props) {
  ...
  var setPage = props.setPage;
  var steps = [
    { label: lang==="de" ? "Angebot erstellen" : lang==="fr" ? "Creer la proposition" : "Write the proposal",    detail: lang==="de" ? "KI schreibt in 30 Sekunden" : lang==="fr" ? "L'IA redige en 30 secondes" : "AI writes it in 30 seconds" },
    { label: lang==="de" ? "Senden & verfolgen" : lang==="fr" ? "Envoyer & suivre" : "Send and track",           detail: lang==="de" ? "Sieh wann & wie oft geoeffnet" : lang==="fr" ? "Vu quand et combien de fois" : "See when and how often viewed" },
    ...
    { label: lang==="de" ? "Bezahlt werden" : lang==="fr" ? "Etre paye" : "Get paid",                            detail: lang==="de" ? "SEPA + automatische Erinnerungen" : lang==="fr" ? "SEPA + relances automatiques" : "SEPA + automatic reminders" },
  ];
      ...
      <div style={{ maxWidth:960, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:64 }}>
          <h2 style={{ fontFamily:fSerif, fontSize:"clamp(26px,4.5vw,52px)", fontWeight:400, color:L.ink, letterSpacing:"-0.03em", lineHeight:1.1, marginBottom:12, fontStyle:"italic" }}>
            {lang==="de" ? "Wie es fliesst." : lang==="fr" ? "Comment ca s'enchaine." : "How it flows."}
          </h2>
          <p style={{ fontFamily:fSans, fontSize:14, color:L.muted, fontWeight:300, maxWidth:320, margin:"0 auto" }}>
            {lang==="de" ? "Vier Schritte. Ein Tool." : lang==="fr" ? "Quatre etapes. Un outil." : "Four steps. One tool. Nothing duplicated."}
          </p>
        </div>
...
export function WhyItWorksSection(props) {
  ...
  var statements = lang==="de" ? [
    { headline:"Weniger Zeit mit Nachverfolgen.", sub:"Sieh sofort, wenn ein Angebot geoeffnet wird - und folge im richtigen Moment nach." },
    { headline:"Fuer ganz Europa gebaut.", sub:"VAT, Reverse Charge, XRechnung, SEPA. Automatisch. Richtig." },
    { headline:"Immer wissen, was als naechstes kommt.", sub:"Dein Dashboard zeigt genau, was Aufmerksamkeit braucht." },
  ] : lang==="fr" ? [
    { headline:"Moins de temps a relancer.", sub:"Voyez quand une proposition est ouverte. Relancez au bon moment." },
    { headline:"Concu pour toute l'Europe.", sub:"TVA, autoliquidation, Factur-X, SEPA. Automatiquement. Correctement." },
      ...
      <div style={{ maxWidth:800, margin:"0 auto", position:"relative", zIndex:1 }}>
        <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:44 }}>
          ...
          <span style={{ fontFamily:fMono, fontSize:11, color:L.accent, letterSpacing:"0.12em", textTransform:"uppercase", opacity:0.7 }}>
            {lang==="de" ? "Warum es funktioniert" : lang==="fr" ? "Pourquoi ca marche" : "Why it works"}
          </span>
        </div>
